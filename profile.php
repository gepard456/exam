...
if(Input::exists())
{
    if(Token::check(Input::get('token')))
    {
        ...
        if($validate->passed())
        {
            $user->update(['name' => Input::get('name'), 'status' => Input::get('status')]);
            Session::flash('profile_update', 'profile update');
     ...
     <div class="row">
       <div class="col-md-8">
         <h1>Профиль пользователя - <?php echo $user->data()->name?></h1>
           ...
           <?php
           if(!Input::exists() && $flash = Session::flash('profile_update'))
         ...
         <form class="form" action="" method="post">
           ...
           <div class="form-group">
             ...
             <input type="text" name="name" id="name" class="form-control" value="<?php echo $user->data()->name?>">
           </div>
           <div class="form-group">
